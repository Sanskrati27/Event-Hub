<%-- 
    ...
    Created on : Mar 4, 2021, 4:44:38 PM
...
<head>
    ...
    <!-- Title Page-->
    <title>Dashboard | Admin | Account </title>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Admin > Account</h2>
                                <div class="wrapper bg-white mt-sm-5">
        <h4 class="pb-4 border-bottom">Account settings</h4>
        
             <form action="admin7.jsp"  onsubmit="myFunction()">
        <div class="py-2">
            <div class="row py-2">
                <div class="col-md-12"> <label for="firstname">Name</label> <input type="text" name="name" class="bg-light form-control" value="<%=session.getAttribute("3")%>"> </div>
            </div>
            <div class="row py-2">
                <div class="col-md-12"> <label for="email">Email Address</label> <input type="text" name="email" class="bg-light form-control" value="<%=session.getAttribute("1")%>" readonly=""> </div>
            </div>
            <div class="row py-2">
                <div class="col-md-12"> <label for="password">Password</label> <input type="password" name="password" class="bg-light form-control" value="<%=session.getAttribute("2")%>"> </div>
            </div>
            
            <div class="py-3 pb-4 border-bottom"> 
                <input type="submit" class="btn btn-primary mr-3" value="Save Changes">
                <input type="reset" class="btn border b" value="Cancel">
            </div>
        </div>
        </form>
       </div>
