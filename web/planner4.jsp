...
<head>
    ...
    <!-- Title Page-->
    <title>Dashboard | Planner | View bookings</title>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">View Bookings</h2>
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                try 
                                                {
                                                    ...
                                                    rs = stmt.executeQuery("SELECT * FROM EVENT ORDER BY bid DESC");
                                                    int i=0;
                                                    while (rs.next())  
                                                    {      
                                            %>  
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <span class="block-email"><%=rs.getString(4)%></span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <a href="planner6.jsp?id=<%=rs.getString(1)%>">
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Change Status">
                                                            <i class="zmdi zmdi-edit"></i>
                                                            </button>
                                                        </a>&nbsp;&nbsp;
                                                        <a href="delete4.jsp?id=<%=rs.getString(1)%>">
                                                            <button class="item" data-toggle="tooltip" data-placement="top" title="Delete Booking" onclick="myFunction()">
