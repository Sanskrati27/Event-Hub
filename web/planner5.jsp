...
<head>
    ...
    <!-- Title Page-->
    <title>Dashboard | Planner | View Feedback</title>
             ...
             <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Feedback Of Customers</h2>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            ...
                                            <%
                                                ...
                                                ResultSet rs = null;
                                                String email=null, name=null, review=null, experience=null, resp=null, support=null, satisfaction=null, rating=null, extra=null;
                                                try 
                                                {
                                                    con=databaseconnection.getconnection();
                                                    stmt = con.prepareStatement("select * from feedback ORDER BY name");
                                                    ...
                                                    {                                                       
                                                        ...
                                                        resp = rs.getString(5);
                                                        support = rs.getString(6);
                                                        satisfaction = rs.getString(7);
                                                        rating = rs.getString(8);
                                                        extra = rs.getString(9);
                                            %>                            
                                        </thead>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-right"><%=satisfaction%></td>
