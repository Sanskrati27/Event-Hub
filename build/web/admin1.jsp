...
<head>
    ...
    <!-- Title Page-->
    <title>Dashboard | Admin | Planner Details </title>
    ...
    <script>
        function myFunction() {
            alert("Delete this planner permanently");
        }
    </script>
</head>
                    ...
                    <div class="container-fluid">
                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                ...
                                <i class="zmdi zmdi-plus"></i>add planner</button></a>
                                <h2 class="title-1 m-b-25">Planner Details</h2>
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            ...
                                            <%
                                                ...
                                                try 
                                                {
                                                    ...
                                                    rs = stmt.executeQuery("SELECT * FROM PLANNER_REGISTER ORDER BY name");
                                                    int i=0;
                                                    while (rs.next())  
                                                    {                                                       
                                            %>                            
                                       ...
                                       <tbody>
                                            <tr>
                                                ...
                                                <td><a href="delete_planner.jsp?emailid=<%=rs.getString(3)%>">
                                                        <button class="au-btn au-btn-icon au-btn--blue" onclick="myFunction()"><i class="fas fa-trash-alt"></i>  Delete</button></a></td>
                                            </tr>
                                        </tbody>
                                        <%
                                            i++;
