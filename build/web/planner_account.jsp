<%-- 
    Document   : planner_account
    Created on : Mar 5, 2021, 11:56:18 AM
...
<head>
    ...
    <!-- Title Page-->
    <title>Dashboard | Planner | Account</title>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                         ...
                         <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Planner > Account</h2>
                                <div class="wrapper bg-white mt-sm-5">
        <h4 class="pb-4 border-bottom">Account settings</h4>
        
        <form action="planner7.jsp" method="post" onsubmit="myFunction()">
            
        <div class="py-2">
            <div class="row py-2">
                <div class="col-md-12"> <label for="firstname">Name</label> <input type="text" name="name" class="bg-light form-control" value="<%=session.getAttribute("6")%>"> </div>
            </div>
            <div class="row py-2">
                <div class="col-md-12"> <label for="email">Email Address</label> <input type="text" name="email" class="bg-light form-control" value="<%=session.getAttribute("4")%>" readonly=""> </div>
            </div>
            <div class="row py-2">
                <div class="col-md-12"> <label for="password">Password</label> <input type="password" name="password" class="bg-light form-control" value="<%=session.getAttribute("5")%>"> </div>
            </div>
            <div class="row py-2">
                <div class="col-md-12"> <label for="type">Planner Type</label> <input type="text" name="type" class="bg-light form-control" value="<%=session.getAttribute("10")%>"> </div>
            </div>
            ...
            <div class="ml-auto">
                <%
                                                ...
                                                try 
                                                {
                                                    ...
                                                    stmt = con.prepareStatement("select * FROM planner_register where email='"+session.getAttribute("4")+"'");
                                                    rs = stmt.executeQuery();
                                                    while(rs.next())  
                                                    {                                                       
                                            %>  
                                            <a href="delete2.jsp?email=<%=rs.getString("email")%>">
                                            <%
                                                    }
