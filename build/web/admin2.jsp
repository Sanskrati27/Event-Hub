...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title Page-->
        <title>Dashboard | Admin | Customer Details </title>
        ...
        <script>
            function myFunction() {
                alert("Delete this user permanently");
            }
        </script>
    </head>
                                        ...
                                        <table class="table table-borderless table-striped table-earning">
                                            <thead>
                                                ...
                                                <%
                                                    ...
                                                    ResultSet rs = null;
                                                    String email = null, name = null, contact = null;
                                                    try {
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><%=email%></td> 
                                                    <td>+91 <%=contact%></td>
                                                    <td><a href="delete.jsp?email=<%=rs.getString("email")%>">
                                                            <button class="au-btn au-btn-icon au-btn--blue"  onclick="myFunction()">
                                                                <i class="fas fa-trash-alt" ></i>  Delete</button></a></td>
                                                </tr>
