                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">          
                         <div class="row">
                             <div class="col-lg-12">
                                 <br><br><br><br><br><br>
                                 <h1 class="title-1 m-b-25" style="text-align: center;font-weight: bolder;font-size: 70px;">Dear <%= session.getAttribute("9")%>, </h1>  
                                  <h1 class="title-1 m-b-25" style="text-align: center;font-weight: bolder;font-size: 70px;">Your Dashboard is here... </h1>  
                             </div>
                         </div>
                        <div class="row">
                            <div class="col-md-12">
